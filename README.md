...
####  12.5&emsp; 在 Linux 系统中运行下图程序，但把输出结果重定向到一个文件中，并解释结果。

####  12.6&emsp; 在 Linux 系统中运行下图程序，但把输出结果重定向到一个文件中，并解释结果。

####  12.7&emsp; 在 Linux 系统中运行下图程序，但把输出结果重定向到一个文件中，并解释结果。

####  12.8&emsp; 在 Linux 系统中运行下图程序，但把输出结果重定向到一个文件中，并解释结果。
